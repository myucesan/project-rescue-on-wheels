...
\begin{document}
	...
	We were given another robot however this one wasn't without it's problems either. The actuators that drive the wheels were acting up. Sometimes some of them wouldn't work. After attempting more fixes for this problem we were given our third and final rover. This one is the one we are currently using and seems to work well enough for us to be able to complete the ROW project.\\
	...
	To counteract this and provide enough of a challenge for us, we came up with the idea to try and make the rover amphibious. This would provide a sufficient or maybe a slightly too big of a challenge but at least it would not be completed within one of it's four sprints and leave us to our own devices.
	\newpage
