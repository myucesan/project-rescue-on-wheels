...
class CamHandler(BaseHTTPRequestHandler):
        def do_GET(self):
			...
			face_detector = cv2.CascadeClassifier('/home/pi/Cascades/haarcascade_frontalface_default.xml')
			...
			count = 0
					...
					for (x,y,w,h) in faces:
						...
						cv2.imwrite("/home/pi/dataset/User.{}.{}.jpg".format(face_id, count), gray[y:y+h,x:x+w])
